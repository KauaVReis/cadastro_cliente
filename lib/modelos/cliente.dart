...
class ServicoClientes {
  ...
  Future<bool> cadastrar(Cliente cliente) async {
    ...
    final query = await _colecao.where('email', isEqualTo: cliente.email.toLowerCase()).get();
    if (query.docs.isNotEmpty) {
      print("Erro: Ja existe um cliente cadastrado com este email ${cliente.email}");
  ...
  Future<Cliente?> login(String email, String senha) async {
    ...
    // Assegura que o snapshot é do tipo correto
